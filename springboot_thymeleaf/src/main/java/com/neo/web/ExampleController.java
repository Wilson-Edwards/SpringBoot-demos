...
/**
 * @program: springboot_thymeleaf->ExampleController
 * @description: 样例的controller
 * @author: lin qx
...
public class ExampleController {
    ...
    public String url(ModelMap map) {
        ...
        map.addAttribute("pageId", "springcloud/2107/09/11");
    ...
    /**
     * private 函数放在public函数后面，用户主要关注public函数
     * @return List<User> 返回用户列表
     */
    private List<User> getUserList() {
        List<User> list = new ArrayList<User>();
        User user1 = new User("大牛", 12, "123456");
        User user2 = new User("小牛", 6, "1234563");
